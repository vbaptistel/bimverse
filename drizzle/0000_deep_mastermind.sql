...
--> statement-breakpoint
CREATE TABLE "companies_to_suppliers" (
	"company_id" uuid NOT NULL,
	"supplier_id" uuid NOT NULL,
	CONSTRAINT "companies_to_suppliers_company_id_supplier_id_pk" PRIMARY KEY("company_id","supplier_id")
);
--> statement-breakpoint
...
ALTER TABLE "companies_to_suppliers" ADD CONSTRAINT "companies_to_suppliers_company_id_companies_id_fk" FOREIGN KEY ("company_id") REFERENCES "public"."companies"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "companies_to_suppliers" ADD CONSTRAINT "companies_to_suppliers_supplier_id_suppliers_id_fk" FOREIGN KEY ("supplier_id") REFERENCES "public"."suppliers"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "proposal_sequences" ADD CONSTRAINT "proposal_sequences_company_id_companies_id_fk" FOREIGN KEY ("company_id") REFERENCES "public"."companies"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE UNIQUE INDEX "proposals_company_year_seq_ux" ON "proposals" USING btree ("company_id","year","seq_number");--> statement-breakpoint
